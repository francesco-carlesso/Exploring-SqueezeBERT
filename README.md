...
This project investigates **SqueezeBERT**, a compact and efficient NLP model designed for **mobile devices** and real-time applications.  
SqueezeBERT balances **accuracy** and **inference speed** by using techniques like **bottleneck layers**, **residual networks**, and **grouped convolutions**.
